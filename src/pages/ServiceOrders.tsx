...
//     }
//     // Status filter - FIXED
//     if (searchStatus && so.status !== searchStatus) {
//       return false;
//     }
//     // Priority filter - FIXED
//     if (searchPriority && so.priority !== searchPriority) {
//       return false;
//     }
...
//               className="bg-red-600 text-white px-3 md:px-4 py-1.5 md:py-2 rounded-lg hover:bg-red-700 transition-all duration-200 flex items-center gap-1.5 text-sm"
//             >
...
//                 {/* Compact Grid Layout - same as before */}
  ...
  />
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 text-sm border border-gray-300 rounded-xl focus:border-indigo-600 focus:ring-2 focus:ring-indigo-600/20 outline-none transition-all duration-200 hover:border-gray-400"
                      required
                    />
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 text-sm border border-gray-300 rounded-xl focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 outline-none transition-all duration-200 hover:border-gray-400"
                      required
                    />
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 text-sm border border-gray-300 rounded-xl focus:border-red-600 focus:ring-2 focus:ring-red-600/20 outline-none transition-all duration-200 hover:border-gray-400"
                    />
                  </div>
                </div>
              </div>
