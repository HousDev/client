      ...
      data.map(async (company) => {
        try {
          ...
          return {
            ...
            active_branch_count: locations.filter(loc => loc.is_active).length, // Active branches
          };
        } catch (error) {
          console.error(`Error loading locations for company ${company.id}:`, error);
          return {
...
const handleDeleteOfficeLocation = async (locationId: string) => {
          ...
          String(company.id) === String(selectedCompany.id)
            ? { 
                ...
                active_branch_count: company.active_branch_count ? 
                  Math.max(0, company.active_branch_count - 1) : 0
              }
            : company
        )
      );
 ...
 const handleToggleStatus = async (locationId: string, currentStatus: boolean) => {
  try {
    ...
    const branch = companyOfficeLocations.find(loc => String(loc.id) === locationId);
    if (!branch) {
...
<div className="pt-3 border-t border-gray-100">
  <div className="flex items-center justify-between mb-2">
    ...
    <div className="flex items-center gap-2">
      <span className="text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full font-medium">
        {(company as any).active_branch_count || 0} Active
      </span>
      <span className="text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded-full font-medium">
        {((company as any).branch_count || 0) - ((company as any).active_branch_count || 0)} Inactive
      </span>
    </div>
  </div>
  <div className="flex gap-2">
          ...
          <div className="bg-gradient-to-r from-gray-50 to-white px-6 py-4 border-b border-gray-200">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-gray-900">Security Configuration</h2>
                  <p className="text-sm text-gray-600 mt-0.5">Configure system security and attendance settings</p>
                </div>
              </div>
              <div className="flex gap-3">
                <Button
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-white border-2 border-gray-200 rounded-xl hover:border-gray-300 transition-all duration-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900">Location Validation</p>
                        <p className="text-sm text-gray-600 mt-0.5">Require employees to be within office radius to punch</p>
                      </div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setSecuritySettings({
                              ...securitySettings,
                              punch_in_radius_meters: parseInt(e.target.value) || 200,
                            })
                          }
                          className="w-full px-4 py-2.5 text-sm border-2 border-gray-200 rounded-xl focus:border-[#C62828] focus:ring-2 focus:ring-[#C62828]/20 outline-none transition-all duration-200"
                        />
                        <p className="text-xs text-gray-500 mt-1">Distance allowed for punch-in</p>
                      </div>
                      <div>
                        <label className="block text-sm font-semibold text-gray-800 mb-2">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setSecuritySettings({
                              ...securitySettings,
                              punch_out_radius_meters: parseInt(e.target.value) || 200,
                            })
                          }
                          className="w-full px-4 py-2.5 text-sm border-2 border-gray-200 rounded-xl focus:border-[#C62828] focus:ring-2 focus:ring-[#C62828]/20 outline-none transition-all duration-200"
                        />
                        <p className="text-xs text-gray-500 mt-1">Distance allowed for punch-out</p>
                      </div>
                      <div>
                        <label className="block text-sm font-semibold text-gray-800 mb-2">
                          Max Distance (meters)
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setSecuritySettings({
                              ...securitySettings,
                              max_punch_distance_meters: parseInt(e.target.value) || 500,
                            })
                          }
                          className="w-full px-4 py-2.5 text-sm border-2 border-gray-200 rounded-xl focus:border-[#C62828] focus:ring-2 focus:ring-[#C62828]/20 outline-none transition-all duration-200"
                        />
                        <p className="text-xs text-gray-500 mt-1">Maximum punch distance allowed</p>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-white border-2 border-gray-200 rounded-xl hover:border-gray-300 transition-all duration-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900">Allow Remote Punch</p>
                        <p className="text-sm text-gray-600 mt-0.5">Allow employees to punch from outside office</p>
                      </div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-white border-2 border-gray-200 rounded-xl hover:border-gray-300 transition-all duration-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900">Auto Punch-Out</p>
                        <p className="text-sm text-gray-600 mt-0.5">Automatically logout if outside office radius</p>
                      </div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setSecuritySettings({
                              ...securitySettings,
                              auto_punchout_radius_km: parseFloat(e.target.value) || 1.0,
                            })
                          }
                          className="w-full px-4 py-2.5 text-sm border-2 border-gray-200 rounded-xl focus:border-[#C62828] focus:ring-2 focus:ring-[#C62828]/20 outline-none transition-all duration-200"
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setSecuritySettings({
                              ...securitySettings,
                              auto_punchout_delay_minutes: parseInt(e.target.value) || 15,
                            })
                          }
                          className="w-full px-4 py-2.5 text-sm border-2 border-gray-200 rounded-xl focus:border-[#C62828] focus:ring-2 focus:ring-[#C62828]/20 outline-none transition-all duration-200"
                        />
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-white border-2 border-gray-200 rounded-xl hover:border-gray-300 transition-all duration-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900">Geolocation Tracking</p>
                        <p className="text-sm text-gray-600 mt-0.5">Track employee location during work hours</p>
                      </div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                  ...
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-white border-2 border-gray-200 rounded-xl hover:border-gray-300 transition-all duration-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900">Selfie on Punch</p>
                        <p className="text-sm text-gray-600 mt-0.5">Require photo verification for punches</p>
                      </div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                  ...
                  {securitySettings.require_selfie_on_punch && (
                    <div className="p-4 bg-gradient-to-r from-pink-50 to-pink-100 border-2 border-pink-200 rounded-xl">
                      <div className="flex items-center justify-between mb-3">
                        <div>
                          <p className="font-semibold text-gray-900">Live Selfie Verification</p>
                          <p className="text-sm text-gray-600 mt-0.5">Require live photo capture (not from gallery)</p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input
                            type="checkbox"
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mt-0.5">Enable AI-based face matching</p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input
                            type="checkbox"
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-gradient-to-r from-amber-50 to-amber-100 border-2 border-amber-200 rounded-xl">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900">Time Restrictions</p>
                        <p className="text-sm text-gray-600 mt-0.5">Set allowed punch-in/out times</p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          type="time"
                          value={formatTimeForInput(securitySettings.max_punch_in_time)}
                          onChange={(e) =>
                            setSecuritySettings({
                              ...securitySettings,
                          ...
                          className="w-full px-4 py-2.5 text-sm border-2 border-gray-200 rounded-xl focus:border-[#C62828] focus:ring-2 focus:ring-[#C62828]/20 outline-none transition-all duration-200"
                        />
                        <p className="text-xs text-gray-500 mt-1">Latest time to punch-in</p>
                      </div>
                      <div>
                        <label className="block text-sm font-semibold text-gray-800 mb-2">
                          Min Punch-Out Time
                        ...
                        <input
                          type="time"
                          value={formatTimeForInput(securitySettings.min_punch_out_time)}
                          onChange={(e) =>
                            setSecuritySettings({
                              ...securitySettings,
                          ...
                          className="w-full px-4 py-2.5 text-sm border-2 border-gray-200 rounded-xl focus:border-[#C62828] focus:ring-2 focus:ring-[#C62828]/20 outline-none transition-all duration-200"
                        />
                        <p className="text-xs text-gray-500 mt-1">Earliest time to punch-out</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-white border-2 border-gray-200 rounded-xl hover:border-gray-300 transition-all duration-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900">Allow Weekend Punch</p>
                        <p className="text-sm text-gray-600 mt-0.5">Allow employees to punch on weekends</p>
                      </div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
