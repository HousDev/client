          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="w-full pl-10 pr-4 py-2 border-2 border-gray-200 rounded-xl focus:border-[#C62828] focus:ring-2 focus:ring-[#C62828]/20 outline-none transition-all duration-200 hover:border-gray-300 text-sm"
              />
            </div>
          </div>
          <div className="flex gap-3">
            <div ref={dropdownRef} className="relative">
              <button
                ...
                className="bg-white border-2 border-gray-200 text-gray-700 px-4 py-2 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 flex items-center gap-2 font-medium shadow-sm text-sm"
              >
              ...
              {showFilterOptions && (
                <div className="absolute right-0 mt-2 w-48 bg-white shadow-xl border-2 border-gray-200 rounded-xl z-50">
                  ...
                  <div className="max-h-64 overflow-y-auto">
                    <div className="p-2">
                      {CATEGORY_OPTIONS.map((categoryGroup) => (
                        <div key={categoryGroup.name} className="mb-2">
                          <button
                            onClick={() =>
                              setShowSubFilterOption(
                                showSubFilterOption === categoryGroup.name 
                                  ? "" 
                                  : categoryGroup.name
                              )
                            }
                          ...
                          >
                            ...
                            <ChevronDown 
                              className={`w-4 h-4 transition-transform ${
                                showSubFilterOption === categoryGroup.name ? "rotate-180" : ""
                              }`}
                            />
                          </button>
                              ...
                              {categoryGroup.values.map((item) => (
                                ...
                                >
                                  <input
                                    ...
                                    onChange={() => setSelectedFilter(item.value)}
