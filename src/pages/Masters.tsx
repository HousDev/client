...
import { Package, FileText, CreditCard, Building2, FileType, Wrench, Tag, Percent, Users } from 'lucide-react';
...
export default function Masters() {
  ...
  const tabs = [
    ...
    },
    {
      ...
      component: () => <GenericMaster tableName="po_types" title="PO Types" description="Manage purchase order types" icon={FileType} />,
    },
    {
      id: 'service_types',
      label: 'Service Types',
      ...
      component: () => <GenericMaster tableName="service_types" title="Service Types" description="Manage service types" icon={Wrench} />,
    },
    {
      id: 'terms',
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Manage all master data for the system</p>
      </div>
            ...
            return (
              <button
                ...
                className={`p-4 text-left transition hover:bg-gray-50 ${
                  activeTab === tab.id ? 'bg-blue-50 border-b-4 md:border-b-0 md:border-t-4 border-blue-600' : ''
                }`}
              >
