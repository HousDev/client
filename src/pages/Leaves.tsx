              ...
              {filteredLeaves.length === 0 ? (
                <tr>
                  <td colSpan={9} className="px-3 md:px-4 py-8 text-center">
                    ...
                    <p className="text-gray-600 text-sm md:text-lg font-medium">No Leave Requests Found</p>
                ...
                filteredLeaves.map((leave) => {
                  ...
                  return (
                    <tr key={leave.id} className={`hover:bg-gray-50 transition ${isSelected ? 'bg-blue-50' : ''}`}>
                      ...
                      <td className="px-3 md:px-4 py-3">
                        <div>
                          <p className="text-xs md:text-sm font-medium text-gray-800">{leave.employee_name}</p>
                          <div className="flex items-center gap-2 mt-1">
                            <Mail className="w-3 h-3 text-gray-400" />
                            <span className="text-[10px] md:text-xs text-gray-500">{leave.employee_email}</span>
                          </div>
                        </div>
                      </td>
                      
                      <td className="px-3 md:px-4 py-3">
                        <span className="text-xs md:text-sm text-gray-700">{leave.leave_type}</span>
                      </td>
                      
                      <td className="px-3 md:px-4 py-3">
                        <span className="text-xs md:text-sm text-gray-700">{new Date(leave.from_date).toLocaleDateString()}</span>
                      </td>
                      
                      <td className="px-3 md:px-4 py-3">
                        <span className="text-xs md:text-sm text-gray-700">{new Date(leave.to_date).toLocaleDateString()}</span>
                      </td>
                      ...
                      <td className="px-3 md:px-4 py-3">
                        <span className="text-xs md:text-sm font-medium text-gray-800">
                          {leave.is_half_day ? '0.5' : leave.total_days}
                          {leave.is_half_day && (
                            <span className="text-[10px] md:text-xs text-gray-500 ml-1">(½ day)</span>
                          )}
                        </span>
                      </td>
