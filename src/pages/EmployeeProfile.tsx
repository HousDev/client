...
export default function EmployeeProfile({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
              ...
              {tabs.map((tab) => {
                ...
                return (
                  ...
                  >
                    ...
                    {tab.label}
                    {isActive && (
                      <CheckCircle className="w-4 h-4 ml-auto text-[#C62828]" />
                    )}
                  </button>
                );
              })}
      ...
      <div className="hidden md:block sticky top-16 z-50 bg-white">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 md:py-6 lg:py-8">
                    ...
                    <div className="space-y-1 md:space-y-2 z-10">
                      <p className="text-base md:text-lg lg:text-lg text-white font-medium">
                        {employee.designation +
                          " " +
                          (employee.role_name || "").charAt(0).toUpperCase() +
                          (employee.role_name || "").slice(1) ||
                          "No designation"}
                      </p>
        ...
        <div className="hidden md:grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-3 lg:gap-4 mb-4 md:mb-6">
          {[
            ...
            <div
              key={i}
              className="bg-white rounded-lg md:rounded-xl border p-2 md:p-3 lg:p-4 shadow-sm"
            >
              <div className="flex items-center gap-2 md:gap-3">
                <div
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-900">
                      {employee.date_of_birth
                        ? `${calculateAge(employee.date_of_birth)} years`
                        : "N/A"}
                    </p>
                  </div>
                  <div>
                ...
                <div className="bg-white rounded-lg md:rounded-xl border p-3 md:p-4 lg:p-6 shadow-sm">
                  ...
                  <div className="flex flex-wrap gap-1 md:gap-2">
                    {allottedProjects.map((projectId: number) => (
                      <span
                        key={projectId}
                        className="px-2 md:px-3 py-1 md:py-1.5 bg-blue-100 text-blue-700 rounded-full text-xs md:text-sm font-medium"
                      >
                        Project #{projectId}
                      </span>
                    ))}
