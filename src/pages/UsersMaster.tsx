...
//   delete_pos: false,
//   approve_pos: false,
//   view_service_orders: false,
//   create_service_orders: false,
//   edit_service_orders: false,
//   view_materials: false,
//   receive_materials: false,
//   view_payments: false,
//   make_payments: false,
//   view_reports: false,
...
//             permissions: (u.permissions as Permissions) || defaultPermissions,
//           }))
//         );
//       })
//       .catch((err) => {
...
//       } else {
//         // create
//         // optional duplicate email check is handled by backend; keep UX check too
...
//     let newPermissions: Permissions = { ...defaultPermissions };

//     if (role === 'admin') {
//       newPermissions = Object.keys(defaultPermissions).reduce((acc, key) => {
//         (acc as any)[key] = true;
//         return acc;
//       }, { ...defaultPermissions } as Permissions);
