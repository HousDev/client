...
interface ProjectUpdateFormProps {
  ...
  loadAllData: any;
  projectData: any; // Existing project data to edit
  allCommonArea: any;
  allFloors: any;
}
...
export default function UpdateProject({
  ...
  const openWorkflowModal = (
    ...
    // Create a copy of workflow statuses for editing
    setWorkflowStatuses([
  ...
  const saveWorkflowStatuses = () => {
    ...
    if (workflowModalData.type === "flat") {
      ...
      // Update flat status based on workflow progress
      ...
      // Update common area status based on workflow progress
      const completedTasks = workflowStatuses.filter(
        (task) => task.status === "completed"
      ).length;
      const totalTasks = workflowStatuses.length;
  ...
  const addMultipleFloors = (buildingIndex: number, count: number) => {
    ...
    // Clear existing floors and add new ones
    building.floors = [];
  ...
  const addMultipleFlats = (
    ...
    // Clear existing flats and add new ones
    floor.flats = [];
  ...
  // Update functions for modal editing
