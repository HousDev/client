...
const TaskProject = ({
  ...
  const fetchProjects = async () => {
    try {
      let projectRes: any;
      if (user?.role === "admin") {
        projectRes = await projectApi.getProjects();
      } else {
        const emp = await HrmsEmployeesApi.getEmployeeByEmail(user.email);
        projectRes = await projectApi.getEmployeeProjects(emp.id);
      }
          ...
          return (
            ...
            >
              ...
              <div className="relative h-32 sm:h-36 md:h-40 overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
                ...
                <div
                  className="absolute bottom-0 left-0 w-0 h-1 bg-[#C62828] 
              ...
              <div className="p-3 sm:p-4 md:p-5 space-y-3 sm:space-y-4">
                ...
                <div className="flex items-start gap-2">
                  <div
                    className="mt-0.5 p-1.5 sm:p-2 bg-[#C62828]/10 rounded-lg shrink-0
                  ...
                  <h1
                    className="font-bold text-sm sm:text-base md:text-lg text-gray-800 
                ...
                {/* View Details Button */}
                <div
                  className="pt-2 flex items-center justify-between text-[#C62828] 
