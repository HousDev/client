...
const MaterialInTransactions = (loadTableData: any) => {
  ...
  useEffect(() => {
    ...
    setFilteredTransactions(filtered);
  }, [searchPONumber, searchVendor, searchChallan, searchReceiver, searchTransType, searchReceivingDate, startDate, endDate, ignoreDate, transactions]);
              ...
              {filteredTransactions.map((transaction: any) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-2 md:px-4 py-2">
                      <div className="text-gray-800 text-xs md:text-sm truncate max-w-[120px]" title={transaction.vendor || "N/A"}>
                        {transaction.vendor || "N/A"}
                      </div>
                    </td>
                    <td className="px-2 md:px-4 py-2">
                      <div className="text-xs md:text-sm truncate max-w-[120px]" title={transaction.challan_number || "N/A"}>
                        {transaction.challan_number || "N/A"}
                      </div>
                    </td>
                    <td className="px-2 md:px-4 py-2">
      ...
      {showFilterSidebar && (
        <div className="fixed inset-0 z-50 overflow-hidden">
          ...
          <div className={`absolute inset-y-0 right-0 bg-white shadow-2xl flex flex-col transition-transform duration-300 ${
            ...
            <div className="bg-gradient-to-r from-[#C62828] to-[#D32F2F] px-4 py-3 flex justify-between items-center">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-white/20 rounded-lg">
                  <Calendar className="w-4 h-4 text-white" />
                </div>
                <div>
                  <h2 className="text-lg font-bold text-white">Date Filters</h2>
                  <p className="text-xs text-white/80">Select a date range to filter transactions</p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="space-y-2">
                    <label className="block text-xs md:text-sm font-semibold text-gray-700 flex items-center gap-2">
                      <Calendar className="w-3 h-3 md:w-4 md:h-4 text-[#C62828]" />
                      From Date
                    </label>
                    <div className="relative">
                      <DatePicker
                        ...
                        className="w-full pl-10 pr-4 py-2 text-xs md:text-sm border border-gray-300 rounded focus:border-[#C62828] focus:ring-1 md:focus:ring-2 focus:ring-[#C62828]/20 outline-none transition-all"
                ...
                {(startDate || endDate) && (
                  <div className="bg-blue-50 border border-blue-200 rounded p-3">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-xs font-medium text-gray-800">Selected Range:</p>
                      ...
                      <button
                        onClick={resetFilters}
                        className="text-[10px] md:text-xs text-red-600 hover:text-red-800 font-medium"
                      >
                        Clear Dates
                      </button>
                    </div>
              ...
              <div className="border-t pt-4">
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded">
                  <input
                    ...
                    className="w-4 h-4 md:w-5 md:h-5 text-[#C62828] border-gray-300 rounded focus:ring-[#C62828]"
                  />
                  <div className="flex-1">
                    <label htmlFor="ignoreDate" className="text-xs md:text-sm font-medium text-gray-700 cursor-pointer block">
                      Ignore Date Filters
                    </label>
                    <p className="text-[10px] md:text-xs text-gray-500">
                      When checked, all dates will be shown regardless of selected range
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="border-t p-3 md:p-4 flex gap-2 md:gap-3">
              <button
                onClick={resetFilters}
                className="flex-1 px-3 md:px-4 py-2 text-xs md:text-sm border border-gray-300 rounded hover:bg-gray-50 transition font-medium text-gray-700 flex items-center justify-center gap-2"
              >
              ...
              <button
                onClick={applyFilters}
                className="flex-1 bg-gradient-to-r from-[#C62828] to-[#D32F2F] text-white px-3 md:px-4 py-2 text-xs md:text-sm rounded hover:shadow-lg transition font-medium flex items-center justify-center gap-2"
              >
