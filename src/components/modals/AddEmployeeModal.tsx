            ...
            <div className="space-y-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          attendence_location: e.target.value,
                        })
                      }
                      className="w-full px-2 py-1.5 text-xs border border-gray-300 rounded focus:border-[#C62828] focus:ring-1 focus:ring-[#C62828] outline-none bg-white"
                      required
                    ...
                    <div className="flex gap-2">
                      ...
                      >
                        ...
                        >
                          ...
                          <ChevronDown
                            className={`w-3 h-3 text-gray-400 transition-transform ${isProjectDropdownOpen ? "rotate-180" : ""}`}
                          />
                        </button>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2">
                ...
                <button
                  type="button"
                  onClick={() =>
                    setShowEducationalDetails(!showEducationalDetails)
                  }
                  className={`flex flex-col items-center justify-center p-2 rounded border transition-all ${
