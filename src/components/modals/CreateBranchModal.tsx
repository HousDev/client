...
export default function CreateBranchModal({ onClose, onSuccess, companyId }: CreateBranchModalProps) {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="border-t border-slate-200 pt-6">
            ...
            {geoError && <div className="p-3 bg-red-50 border border-red-200 text-red-700 rounded-lg text-sm mb-4">{geoError}</div>}
