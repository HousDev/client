...
export default function DepartmentsMaster() {
  ...
  const filteredDepartments = departments.filter((dept) => {
    ...
    const matchesActiveFilter =
      activeFilter === null || dept.is_active === activeFilter;
  ...
  return (
    <div className="px-0  bg-gray-50 ">
      <div className="overflow-y-hidden max-h-[calc(100vh-300px)] md:max-h-[calc(100vh-200px)] ">
        {/* Header */}
        ...
        {statsLoading ? (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="bg-gray-100 rounded-lg p-3 md:p-4 animate-pulse"
              >
        ...
        {loading ? (
          ...
          <>
            {/* Departments Table */}
            <div className=" rounded-lg border border-gray-200 overflow-y-scroll max-h-[calc(90vh-400px)]">
