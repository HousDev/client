    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h2 className="text-xl font-semibold text-gray-800">Roles Management</h2>
                            ...
                            >
                                <div className="flex justify-between items-start mb-3">
                                    ...
                                    <button
                                        ...
                                        className={`px-3 py-1 rounded text-xs font-medium ${role.is_active
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        ...
                                        className="flex-1 bg-red-50 text-red-600 hover:bg-red-100 px-3 py-2 rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2"
                    ...
                    {filteredRoles.length === 0 && (
                        <div className="text-center py-12 border-2 border-dashed border-gray-200 rounded-xl bg-gray-50">
                            ...
                            {!search && (
                                <button
                                    onClick={openCreate}
                                    className="bg-gradient-to-r from-[#C62828] to-red-600 text-white px-6 py-2 rounded-lg flex items-center gap-2 hover:from-red-600 hover:to-red-700 transition-all duration-200 font-medium mx-auto"
                                >
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
                        ...
                        <form onSubmit={handleSubmit} className="p-6 max-h-[calc(90vh-80px)] overflow-y-auto">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#C62828] focus:border-transparent transition-all"
                            ...
                            <div className="mb-8">
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <div className="flex gap-2">
                                        <button
                                            ...
                                            className="px-4 py-2 bg-green-50 text-green-600 text-sm rounded-lg hover:bg-green-100 transition-colors font-medium"
                                        >
                                            Select All
                                        </button>
                                        <button
                                            ...
                                            className="px-4 py-2 bg-gray-50 text-gray-600 text-sm rounded-lg hover:bg-gray-100 transition-colors font-medium"
                                        >
                                            Clear All
                                        </button>
                                    </div>
                                ...
                                <div className="space-y-6">
                                    {permissionCategories.map((category) => (
                                        <div key={category.category} className="border border-gray-200 rounded-xl p-5 bg-gray-50">
                                            <h5 className="font-semibold text-gray-800 mb-4 text-lg">{category.category}</h5>
                                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                                {category.permissions.map((perm) => (
                                                    <label
                                                        key={perm.key}
                                                        className={`flex items-start p-4 border rounded-lg cursor-pointer transition-all ${permissions[perm.key]
                                                    ...
                                                    >
                                                        ...
                                                        <div className="ml-4">
                                                            ...
                                                            {perm.description && (
                                                                <div className="text-sm text-gray-500 mt-1.5">{perm.description}</div>
                                                            )}
                                                        </div>
                                                    </label>
                                                ))}
                            ...
                            <div className="mb-8 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                                <h5 className="font-semibold text-blue-800 mb-2">Permissions Summary</h5>
                            ...
                            <div className="border-t pt-6 flex justify-end gap-4">
                                ...
                                <button
                                    type="submit"
                                    className="bg-gradient-to-r from-[#C62828] to-red-600 text-white px-8 py-2.5 rounded-lg hover:from-red-600 hover:to-red-700 transition-all duration-200 font-medium shadow-sm hover:shadow"
                                >
