          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden md:flex flex-col items-start">
                ...
                <span className="text-xs text-gray-500 truncate">{displayRole}</span>
              </div>
            </button>
          </div>
        </div>
        ...
        <>
          ...
          <div
            className={`fixed z-50 top-16 right-6 lg:right-36 w-[18rem] sm:w-96
              ...
              transform transition-all duration-200 ease-out ${notifOpen ? panelEnter : panelExit}`}
          ...
          >
            ...
            <div className="max-h-72 overflow-y-auto p-3 space-y-3">
              {notifications.length === 0 ? (
                ...
                notifications.map(n => (
                  <div key={n.id} className={`flex items-start gap-3 p-3 rounded-lg ${n.unread ? 'bg-blue-50/60 border border-blue-100' : 'bg-white'}`}>
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500 mt-1">Short description or details here. Add more info to show context.</p>
                    </div>
                  </div>
                ))
              )}
            ...
            <div className="px-3 py-2 border-t flex items-center justify-between bg-gradient-to-b from-white/40 to-white/30">
              ...
              <div className="flex items-center gap-2">
                <button onClick={() => setNotifOpen(false)} className="px-3 py-1 rounded-md bg-gray-100 hover:bg-gray-200 text-sm text-gray-700">
                  Close
                </button>
              </div>
            </div>
        ...
        <>
          ...
          <div
            className={`fixed z-50 top-16 right-6 w-72 sm:w-80 bg-white/97 backdrop-blur-sm border border-gray-200 rounded-lg shadow-xl overflow-hidden
              transform transition-all duration-200 ease-out ${profileOpen ? panelEnter : panelExit}`}
            style={{ willChange: 'transform, opacity' }}
            role="dialog"
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="mt-4 grid gap-2">
                <button
                  onClick={() => { console.log('Go to settings'); setProfileOpen(false); }}
            ...
            <div className="p-2 border-t text-right">
              <button onClick={() => setProfileOpen(false)} className="text-sm text-gray-600 px-2 py-1 rounded hover:bg-gray-50">Close</button>
            </div>
          </div>
        </>
      )}
